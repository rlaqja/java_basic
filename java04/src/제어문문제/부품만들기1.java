...
public class 부품만들기1 {
	...
	public static void main(String[] args) {
		...
		input3.setBackground(Color.black); //배경색
		input3.setForeground(Color.black); //버튼의 위색, 글자색
		input4.setBackground(Color.black); //배경색
		input4.setForeground(Color.black); //버튼의 위색, 글자색
		
		
		text1.setForeground(Color.black); //버튼의 위색, 글자색
		text2.setForeground(Color.black); //버튼의 위색, 글자색
		text3.setForeground(Color.black); //버튼의 위색, 글자색
		text4.setForeground(Color.black); //버튼의 위색, 글자색
		...
		b1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (id.equals("root") && pw.equals("1234") && name.equals("kim") && number.equals("0101234567")) {
